...
- You could use `LEGACY_CARDINALITY_ESTIMATION` scoped database configuration option, to have the whole database use the older CE, while retaining other improvements in the query optimizer.
